    ...
    if(showPriorityColumn) {
        if (alwaysValidate) {
            return [
                ...
                {id:"visitType", name:jQuery("#translatedColumnNames").attr("data-visitType"), field:"visitType", searchable:true, sortable:true, index:6, editor:Slick.Editors.Text, minWidth:100},
        ...
        if (alwaysValidate) {
            return [
                ...
                {id:"visitType", name:jQuery("#translatedColumnNames").attr("data-visitType"), field:"visitType", searchable:true, sortable:true, index:9, editor:Slick.Editors.Text, minWidth:100},
            ...
            return [
                ...
                {id:"visitType", name:jQuery("#translatedColumnNames").attr("data-visitType"), field:"visitType", searchable:true, sortable:true, index:8, editor:Slick.Editors.Text, minWidth:100},
    ...
    if(showPriorityColumn) {
        ...
        if (alwaysValidate) {
            ...
            return [
                ...
                {id:"visitType", name:jQuery("#translatedColumnNames").attr("data-visitType"), field:"visitType", searchable:true, sortable:true, index:7, editor:Slick.Editors.Text, minWidth:100},
    ...
    if(showPriorityColumn) {
        if (alwaysValidate) {
            return [
                ...
                {id:"notes", name:jQuery("#translatedColumnNames").attr("data-notes"), field:"comments", sortable:true, index:11, searchable:false, editor:Slick.Editors.Text, minWidth:170},
                {id:"isCompleted", name:jQuery("#translatedColumnNames").attr("data-completed"), field:"isCompleted", sortable:true, cssClass:"cell-title", index:12, formatter:Slick.Formatters.YesNo, searchable:false, minWidth:120},
                {id:"link", name:jQuery("#translatedColumnNames").attr("data-action"), field:"link", cssClass:"cell-title", formatter:formatter, index:13, editor:Slick.Editors.Text, searchable:false, minWidth:180},
                {id:"isPrinted", name:jQuery("#translatedColumnNames").attr("data-printed"), field:"isPrinted", sortable:true, cssClass:"cell-title", index:14, formatter:Slick.Formatters.Checkmark, searchable:false, minWidth:80},
            ];
        }
        else {
            return [
                ...
                {id:"isCompleted", name:"Completed", field:"isCompleted", sortable:true, cssClass:"cell-title", index:11, formatter:Slick.Formatters.YesNo, searchable:false, minWidth:120},
                {id:"link", name:jQuery("#translatedColumnNames").attr("data-action"), field:"link", cssClass:"cell-title", formatter:formatter, index:12, editor:Slick.Editors.Text, searchable:false, minWidth:180},
                {id:"isPrinted", name:jQuery("#translatedColumnNames").attr("data-printed"), field:"isPrinted", sortable:true, cssClass:"cell-title", index:13, formatter:Slick.Formatters.Checkmark, searchable:false, minWidth:80},
            ];
        }
        ...
        if (alwaysValidate) {
            return [
                ...
                {id:"visitType", name:jQuery("#translatedColumnNames").attr("data-visitType"), field:"visitType", searchable:true, sortable:true, index:10, editor:Slick.Editors.Text, minWidth:100},
                {id:"link", name:jQuery("#translatedColumnNames").attr("data-action"), field:"link", cssClass:"cell-title", formatter:formatter, index:11, editor:Slick.Editors.Text, searchable:false, minWidth:180},
                {id:"isPrinted", name:jQuery("#translatedColumnNames").attr("data-printed"), field:"isPrinted", sortable:true, cssClass:"cell-title", index:12, formatter:Slick.Formatters.Checkmark, searchable:false, minWidth:80},
            ];
        }
    ...
    if(showPriorityColumn) {
        if (alwaysValidate) {
            return [
                ...
                {id:"pendingValidationCount", name:jQuery("#translatedColumnNames").attr("data-pendingValidation"), field:"pendingValidationCount", sortable:true, editor:Slick.Editors.Text, index:9, searchable:false, minWidth:140},
                {id:"totalTestCount", name:jQuery("#translatedColumnNames").attr("data-total"), field:"totalTestCount", sortable:true, editor:Slick.Editors.Text, index:10, searchable:false, minWidth:50},
                {id:"notes", name:jQuery("#translatedColumnNames").attr("data-notes"), field:"comments", sortable:true, index:11, searchable:false, editor:Slick.Editors.Text, minWidth:290},
                {id:"link", name:jQuery("#translatedColumnNames").attr("data-action"), field:"link", cssClass:"cell-title", formatter:formatter, index:12, editor:Slick.Editors.Text, searchable:false, minWidth:180},
                {id:"isPrinted", name:jQuery("#translatedColumnNames").attr("data-printed"), field:"isPrinted", sortable:true, cssClass:"cell-title", index:13, formatter:Slick.Formatters.Checkmark, searchable:false, minWidth:80}
            ];
        }
